...
# Los datos ya vienen con nombre_estudiante y nombre_materia desde la API
# No necesitamos hacer merge con estudiantes.csv y materias.csv
df = notas.copy()

# Por si acaso faltan columnas opcionales
if 'email' not in df.columns:
    df['email'] = ''
if 'descripcion' not in df.columns:
    df['descripcion'] = ''

print("✅ Datos cargados desde datos_limpios.csv")
